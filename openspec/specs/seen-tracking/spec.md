...
The persisted SQLite store that keeps already-delivered items out of subsequent briefings, plus the dedupe and mark-delivered operations that maintain it.
