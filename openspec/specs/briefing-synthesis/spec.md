...
How the daily briefing is generated from the deduped fetcher envelope via headless Claude Code, including the prompt-as-source-of-truth contract and the heuristic web-search branch.
