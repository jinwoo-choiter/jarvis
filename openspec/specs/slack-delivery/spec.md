...
How a synthesized briefing is posted to a Slack channel via an incoming webhook, including the meta-strip safety net and the failure modes that must not advance mark-seen.
